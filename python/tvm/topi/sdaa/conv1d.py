...
"""Compute definition for conv1d with sdaa backend"""
import tvm
from tvm import te
...
@autotvm.register_topi_compute("conv1d_ncw.sdaa")
...
def _schedule_conv1d_ncw(cfg, outs):
    """TOPI schedule callback of conv1d ncw for sdaa gpu
...
@autotvm.register_topi_schedule("conv1d_ncw.sdaa")
def schedule_conv1d_ncw(cfg, outs):
    return _schedule_conv1d_ncw(cfg, outs)


@autotvm.register_topi_compute("group_conv1d_ncw.sdaa")
...
@autotvm.register_topi_schedule("group_conv1d_ncw.sdaa")
def schedule_group_conv1d_ncw(cfg, outs):
    return _schedule_conv1d_ncw(cfg, outs)


@autotvm.register_topi_compute("conv1d_nwc.sdaa")
...
def _schedule_conv1d_nwc(cfg, outs):
    """TOPI schedule callback of conv1d nwc for sdaa gpu
...
@autotvm.register_topi_schedule("conv1d_nwc.sdaa")
def schedule_conv1d_nwc(cfg, outs):
    return _schedule_conv1d_nwc(cfg, outs)


@autotvm.register_topi_compute("group_conv1d_nwc.sdaa")
...
@autotvm.register_topi_schedule("group_conv1d_nwc.sdaa")
