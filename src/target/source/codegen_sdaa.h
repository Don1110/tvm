...
/*!
 * \file codegen_sdaa.h
 * \brief Utility to generate sdaa code
 */
#ifndef TVM_TARGET_SOURCE_CODEGEN_SDAA_H_
#define TVM_TARGET_SOURCE_CODEGEN_SDAA_H_
...
#endif  // TVM_TARGET_SOURCE_CODEGEN_SDAA_H_
